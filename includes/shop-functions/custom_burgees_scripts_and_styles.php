...
add_action( 'wp_footer', 'custom_burgees_scripts_and_styles' );

function custom_burgees_scripts_and_styles() {
    ...
    if($pageID == 523739) : ?>
        ...
        <script>
			...
			if(document.body.classList.contains('postid-523739')) {
				...
				window.addEventListener('load', () => {
					...
					setTimeout(() => { 
						...
						const customQuanityField = document.querySelector('#field_21_31.gfield--type-number input');
...
// 								END CHANGES
								...
								//console.log(`${minimumPrice} vs ${currentPrice}`)
