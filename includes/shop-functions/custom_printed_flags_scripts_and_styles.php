...
add_action( 'wp_footer', 'custom_printed_flags_scripts_and_styles' );

function custom_printed_flags_scripts_and_styles() {
    ...
    if($pageID == 524942) : ?>
		...
		<script>
			...
			if(document.body.classList.contains('postid-524942')) {
				...
				window.addEventListener('load', () => {
					...
					setTimeout(() => { 
						...
						const customQuanityField = document.querySelector('#field_26_39.gfield--type-number input');
						...
						customQuanityField.addEventListener('change', (e) => {
							...
							const observer = new MutationObserver(() => {
								...
								console.log(`${minimumPrice} vs ${totalPrice}`)
